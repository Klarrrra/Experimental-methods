...
#the worst is diet --> it is not signifikant at all
...
mm2 <- lm(Aggression ~ Sibling_Aggression + Parenting_Style, child)

mm3 <- lm(Aggression ~ Sibling_Aggression  + Parenting_Style + Computer_Games, child)
