...
setwd("/Users/marko/Downloads/EmotionalStroopTask")
...
I could build a repeated meassure model: one with random slope and one with random intercept and the compare them using ANOVA(??)
